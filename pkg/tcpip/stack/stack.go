...
type transportProtocolState struct {
	...
	defaultHandler func(r *Route, id TransportEndpointID, pb *buffer.PacketBuffer) bool
}
...
func (s *Stack) SetTransportProtocolHandler(p tcpip.TransportProtocolNumber, h func(*Route, TransportEndpointID, *buffer.PacketBuffer) bool) {
