...
func (e *countedEndpoint) DeliverNetworkPacket(linkEP stack.LinkEndpoint, remote, local tcpip.LinkAddress, protocol tcpip.NetworkProtocolNumber, pb *buffer.PacketBuffer) {
	e.dispatchCount++
}
...
func TestWaitDispatch(t *testing.T) {
	...
	var pb buffer.PacketBuffer
	ep.dispatcher.DeliverNetworkPacket(ep, "", "", 0, &pb)
